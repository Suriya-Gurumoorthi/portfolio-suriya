        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-cyan-400">self.</span>
                <span className="mr-2 text-white">name</span>
                <span className="mr-2 text-pink-500">=</span>
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Suriya G</span>
                <span className="text-gray-400">{`'`}</span>
              </div>
              <div className="ml-8 lg:ml-16">
                <span className="mr-2 text-cyan-400">self.</span>
              ...
              <div>
                <span className="ml-8 lg:ml-16 mr-2 text-cyan-400">self.</span>
                <span className="mr-2 text-white">quick_learner</span>
                <span className="mr-2 text-pink-500">=</span>
                <span className="text-orange-400">True</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="mr-2 text-white">hard_worker</span>
                <span className="text-amber-300 mr-2">and</span>
              </div>
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">self.</span>
                <span className="mr-2 text-white">problem_solver</span>
              ...
              <div>
                <span className="ml-12 lg:ml-24 text-white">len</span>
                <span className="text-gray-400">(</span>
                <span className="text-cyan-400">self.</span>
